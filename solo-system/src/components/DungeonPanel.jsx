  ...
  return (
    <div className="w-full max-w-md border-2 border-purple-900 p-6 rounded-lg bg-black/80 shadow-[0_0_20px_rgba(147,51,234,0.1)] mb-6 font-system">
      ...
      <div className="space-y-3">
        <button onClick={() => enterDungeon('Instant')} className="w-full flex justify-between items-center p-3 border border-purple-900/50 hover:border-purple-500 hover:bg-purple-500/10 transition-all group">
        ...
        <button onClick={() => enterDungeon('Red')} className="w-full flex justify-between items-center p-3 border border-red-900/50 hover:border-red-500 hover:bg-red-500/10 transition-all group">
